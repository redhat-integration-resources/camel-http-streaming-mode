...
5. Stop the engine and inspect the result file.
  ...
  The proxy Camel Quarkus instance should channel back the HTTP byte stream response from the server. The client should dump the data (output) in a file in the 'data' directory.
