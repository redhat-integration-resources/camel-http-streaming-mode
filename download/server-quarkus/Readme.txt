...
4. Stop Camel Quarkus and inspect the result file.

  Camel Quarkus should process the HTTP request and send back the byte stream. The client dumps the data (output) in a file in the 'data' directory.
