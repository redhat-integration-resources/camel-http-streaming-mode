...
The command above creates a 4 Gigabytes (input) file in the `data` directory.
...
Use `curl` to send a request:
	...
	curl -v -o ../data/output http://localhost:8080/test

If you're using the Quarkus/SpringBoot proxy, use the proxy port:

	curl -v -o ../data/output http://localhost:9000/test
